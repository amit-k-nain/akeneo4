 ...
 */
class ProductHistoryCsvProcessor extends \PimProductProcessor
{
    ...
    public const VERSION_HISTORY = 'history';
    ...
    public function process($product)
    {
        ...
        if (isset($product->versionHistory)) {
            $productStandard[self::VERSION_HISTORY] = $product->versionHistory;
        }
